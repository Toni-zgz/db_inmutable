...
(defn guardar-a-disco [datos nombre-fichero]
  (cond (not (list? datos)) (println "El primer argumento debe ser una lista")
        (not (string? nombre-fichero)) (println "El segundo argumento debe ser una cadena")
...
(defn recuperar-de-disco [nombre-fichero]
  (cond (not (string? nombre-fichero)) (println "El argumento debe ser una cadena")
